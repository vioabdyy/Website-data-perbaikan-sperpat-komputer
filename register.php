...
<head>
	...
	<body style="background-image: url(images/poltek.jpg);height: 100%;background-position: center;	background-size: cover;">
<link rel="stylesheet" type="text/css" href="../css/style.css">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Audiowide">
	<div class="container mt-3">
</head>
	<div class="kotak_data">
		<h3 class="tulisan_data"style="font-family:Audiowide; font-weight: bold">Register</h3>
 		<br>
		...
		<div class="card" style="margin-left: 232px;width: 41rem;margin-bottom: 55px;">
		  <div class="card-body">
			...
			<input type="password" name="password" class="form-control" placeholder="Masukkan Password Mahasiswa">
