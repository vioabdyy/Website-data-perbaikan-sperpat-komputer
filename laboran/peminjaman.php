...
<?php
	$sql	= "SELECT * FROM pinjam,barang where pinjam.id_barang = barang.id_barang ";
...
?>
	<tr class="odd gradeX">
		...
		<td>
		<a href="form_peminjaman.php?id_pinjam=<?php echo $data['id_pinjam']; ?>"> <i style="color:green" class="fa fa-eye"></i> </a>
		</td>
	</tr>
<?php
$no++;  
