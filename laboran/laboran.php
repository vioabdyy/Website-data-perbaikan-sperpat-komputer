...
<div class="wall col-md-4" style="width: 30rem; background-color: #FFFAF0">
  <img src="../images/3.jpg" class="wall-img-top" style="width: 100% ;height:100%"alt="...">
</div>
</div>
</div>
...
<br>
<center><p>Laporan Peminjaman</p></center>
<br>
<a href="cari.php" class="btn btn-primary right">Klick Disni</a>
<br>
<br>
</div>
</div>
...
<footer class="bg-light text-lg-start">
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);" >
    © 2022 Copyright:
    <a class="text-dark" href="laboran.php" style="font-family:Audiowide; font-weight: bold">ABDILLAH</a>
  </div>
  <!-- Copyright -->
</footer>
 </body>
